...
class UI {
	...
	static appendProject(project) {
		...
		[_events_js__WEBPACK_IMPORTED_MODULE_0__["default"].selectProject, _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].openEditForm, _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject].forEach(fun => projectElement.addEventListener('click', fun));
	...
	static appendTask(task) {
		const createHeader = (task) => {
			...
			const createButtons = () => {
				...
				if (!task.description && (!task.date || (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.date)))) {
			...
			if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.date))) {
		...
		const createInfo = (task) => {
			...
			if (!task.date || (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.date))) {
		...
		[_events_js__WEBPACK_IMPORTED_MODULE_0__["default"].expand, _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask, _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask].forEach(fun => taskElement.addEventListener('click', fun));
	...
	static #findDateGroup(task) {
		if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.date))) {
			return 'today';
		} else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(task.date), (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), { hours: 0, minutes: 0, seconds: 0, milliseconds: 0 }))) {
			return 'expired';
		} else {
			return 'upcoming';
		}
...
class Events {
	...
	static checkTask(e) {
		if (e.target.classList.contains('checkbox')) {
			...
			const taskElement = _UI_js__WEBPACK_IMPORTED_MODULE_2__["default"].getClosestParent(e.target, '.task');
			console.log(_todoList_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
			_todoList_js__WEBPACK_IMPORTED_MODULE_1__["default"].getTaskById(+taskElement.id).toggleCheck();
		}
	}
	static deleteTask(e) {
		if (e.target.classList.contains('delete')) {
			const taskElement = _UI_js__WEBPACK_IMPORTED_MODULE_2__["default"].getClosestParent(e.target, '.task');
			const task = _todoList_js__WEBPACK_IMPORTED_MODULE_1__["default"].getTaskById(+taskElement.id);
			_todoList_js__WEBPACK_IMPORTED_MODULE_1__["default"].getProject(task.project).deleteTask(task.name);
			_UI_js__WEBPACK_IMPORTED_MODULE_2__["default"].removeTask(taskElement);
		}
	}
}
...
function setDefaultProject() {
	...
	if (_todoList_js__WEBPACK_IMPORTED_MODULE_3__["default"].projects.length <= 1) {
		...
		getStarted.addTask(new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"]('Add your first task! Expand to see more ->', getStarted.name, 'First, create a new project clicking on "Add project", then click on "Add task", set the name, a description and the due date. That\'s it, have fun! Don\'t forget to visit my Github!'));
