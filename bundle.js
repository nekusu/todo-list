...
function setDefaultProject() {
	...
	if (_todoList_js__WEBPACK_IMPORTED_MODULE_3__["default"].projects.length <= 1) {
		const getStarted = new _project_js__WEBPACK_IMPORTED_MODULE_1__["default"]('Get started');
		getStarted.addTask(
			new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"]('Add your first task! Expand to see more ->', getStarted.name, 'First, create a new project clicking on "Add project", then click on "Add task", set the name, a description and the due date. That\'s it, have fun! Don\'t forget to visit my Github!'));
