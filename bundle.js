...
function getStarted() {
	...
	const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), { representation: 'date' });
	getStarted.addTask(
